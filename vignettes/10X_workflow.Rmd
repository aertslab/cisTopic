...
```{r, eval=FALSE}
pathTo10X <- '/media/seq-srv-06/lcb/cbravo/cisTopic_v0.1/10x_example/'
...
```{r, eval = FALSE}
pathToFeather <- "/media/data/lcb/icistarget/data/rankings/feather/hg19-regions-9species.all_regions.mc8nr.feather"
